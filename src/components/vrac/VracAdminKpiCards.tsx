...
const VracAdminKpiCards: React.FC<VracAdminKpiCardsProps> = ({ demandesToday, demandesAll }) => {
    ...
    const globalCards = [
        ...
        { label: 'Tonnage cumulé (T)', value: globalTonnage.toFixed(1), icon: Weight, color: 'text-indigo-600', bg: 'bg-indigo-50' },
        { label: 'Moy. / camion (T)', value: avgTonnage.toFixed(2), icon: Weight, color: 'text-cyan-600', bg: 'bg-cyan-50' },
    ];
