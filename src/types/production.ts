...
export interface LigneProduction {
  ...
  recharges_petro_b28?: number;
  recharges_petro_b38?: number;
  recharges_total_b6?: number;
  recharges_total_b12?: number;
  recharges_total_b28?: number;
  recharges_total_b38?: number;
  recharges_vivo_b6?: number;
  recharges_vivo_b12?: number;
  recharges_vivo_b28?: number;
  recharges_vivo_b38?: number;
  consignes_petro_b6?: number;
  consignes_petro_b12?: number;
  consignes_petro_b28?: number;
  consignes_petro_b38?: number;
  consignes_total_b6?: number;
  consignes_total_b12?: number;
  consignes_total_b28?: number;
  consignes_total_b38?: number;
  consignes_vivo_b6?: number;
  consignes_vivo_b12?: number;
  consignes_vivo_b28?: number;
  consignes_vivo_b38?: number;
  cumul_recharges_b6?: number;
  cumul_recharges_b12?: number;
  cumul_recharges_b28?: number;
  cumul_recharges_b38?: number;
